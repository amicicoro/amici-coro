      ...
      <div className="container mx-auto px-6 sm:px-8 md:px-12">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <div className="flex items-center gap-3">
            <span className="text-sm uppercase tracking-wider">Find us on Facebook</span>
            <Link
          ...
          <div className="space-y-2 text-sm text-gray-600 max-w-2xl">
            ...
            <p>
              The information provided on this website and its social media channels is correct at the time of
              publication.
            </p>
          </div>
