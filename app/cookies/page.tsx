...
export default function CookiePolicy() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-6 sm:px-8 md:px-12 py-16">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-playfair text-center mb-12">COOKIE POLICY FOR AMICI CORO</h1>

          <div className="space-y-8 text-gray-700">
            <p className="text-center italic">
              This is the Cookie Policy for Amici Coro, accessible from https://www.amicicoro.co.uk/
            </p>

            <div className="space-y-4">
              <h2 className="text-2xl font-playfair italic">What Are Cookies?</h2>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-playfair italic">How We Use Cookies</h2>
              <p className="leading-relaxed">
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-playfair italic">Disabling Cookies</h2>
              <p className="leading-relaxed">
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-playfair italic">The Cookies We Set</h2>

              <div className="space-y-6">
                <div className="space-y-2">
                  <h3 className="font-semibold">Account related cookies</h3>
                  <p className="leading-relaxed">
                ...
                <div className="space-y-2">
                  <h3 className="font-semibold">Login related cookies</h3>
                  <p className="leading-relaxed">
                ...
                <div className="space-y-2">
                  <h3 className="font-semibold">Forms related cookies</h3>
                  <p className="leading-relaxed">
                ...
                <div className="space-y-2">
                  <h3 className="font-semibold">Site preferences cookies</h3>
                  <p className="leading-relaxed">
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-playfair italic">Third Party Cookies</h2>
              <p className="leading-relaxed">
              ...
              <p className="leading-relaxed">
                ...
                network in various ways. For these to work the following social media sites; Facebook and Dropbox, will
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-playfair italic">More Information</h2>
              <p className="leading-relaxed">
              ...
              <p className="leading-relaxed">
                However if you are still looking for more information then you can contact us by emailing us at{" "}
                <a href="mailto:amicicoro@yahoo.com" className="text-primary hover:underline">
                  amicicoro@yahoo.com
                </a>
              </p>
            </div>
